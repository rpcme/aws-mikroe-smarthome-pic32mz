...
static int      CommandLogging(SYS_CMD_DEVICE_NODE* pCmdIO, int argc, char** argv);           // log
...
static const SYS_CMD_DESCRIPTOR    _builtinCmdTbl[]=
{
    ...
    {"log",     CommandLogging, ": Logging toggle" }
};
...
static int CommandLogging(SYS_CMD_DEVICE_NODE* pCmdIO, int argc, char** argv)
{
    ...
    (*pCmdIO->pCmdApi->msg)(cmdIoParam, LINE_TERM " *** Logging toggled. ***\r\n" );

    // TODO: understand why this is needed
    //vLoggingToggleStatus();
}
